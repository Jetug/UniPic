...
class ImageAdapter(private val files: ArrayList<File>, var size: Int, private val onClickListener: ItemOnClickListener) : RecyclerView.Adapter<ImageAdapter.ImageHolder>() {
