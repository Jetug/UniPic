    ...
    :RecyclerView.Adapter<HolderType>()
{
    ...
    protected lateinit var actModeCallback: ThumbnailActionModeCallback
...
//                actionMode = mode
//
//                activity.menuInflater.inflate(R.menu.menu_directory_work, menu)
//                var actBar = activity.actionBar
//                if(actBar != null)
//                {
//                    actBar.title = ""
//                }
